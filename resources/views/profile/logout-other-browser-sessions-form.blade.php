<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button data-bs-toggle="modal" data-bs-target="#openPass">
        ...
        <div wire:ignore.self class="modal fade" id="openPass" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <x-jet-danger-button class="ml-4 btn-sm" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                            {{ __('Log Out Other Browser Sessions') }}
                        </x-jet-danger-button>
                    </div>
                </div>
