...
<body>
    <div>
        ...
        <br><br>
        <center>
            <LABEL>FURNITURE AND EQUIPMENT ACKNOWLEDGEMENT REPORT</h1>
                <br>
                <label class="p">
                    <strong>{{$dates}}</strong>
                </label>
        ...
        <table style="table-layout:fixed; margin-top: 20px; border-collapse: collapse;">
            ...
            <tbody>
                ...
                @foreach($items as $i)
                <tr>
                    <td class="td-data">{{$i['fea_number']}}</td>
                    <td class="td-data">{{$i['numItem']}}</td>
                    <td class="td-data">{{$i['subdept']}}</td>
                    <td class="td-dat">{{$i['total_amount']}}</td>
