        ...
        <div class="col-md-9 min-height-form" id="form-content">
            ...
            <div>
                ...
                <div class="d-flex justify-content-between p-1">
                    ...
                    @if(!empty($recordedby))
                    <button data-bs-toggle="modal" data-bs-target="#verticalycentered" class="btn  btn-success btn-save">Save</button>
                    @endif
                </div>
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <div class="row mt-2 justify-content-between">
                            ...
                            <div class="col-md-12 " style="max-width: 400px;">
                                ...
                                <input readonly class="signform-open w-full" wire:model="recordedby">
                            </div>
                    ...
                    <div class="col-md-7 ">
                        ...
                        <div class="row mt-2 justify-content-between">
                            <div class="col-md-6 p-3" style="max-width: 400px;">
                                ...
                                <input disabled class="sigform-disabale w-full" wire:model="receivedby">
                            </div>

                            <div class="col-md-6 p-3" style="max-width: 400px;">
                                <label class="me-1 sig-text">Noted by:</label>
                                <input disabled class="sigform-disabale w-full" wire:model="rnotedby">
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center p-2 mt-3">
                        Have you download the QR codes for this fea?
                        <div class="d-flex justify-content-center mt-3 mb-1">
                            <x-jet-button wire:click="save" class="btn btn-primary ">
                                Yes, Save Fea
                            </x-jet-button>
                            <x-jet-secondary-button type="button" class="ms-2 btn btn-secondary" data-bs-dismiss="modal">
                                Not yet
                            </x-jet-secondary-button>
