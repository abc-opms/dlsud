...
namespace App\Http\Livewire\Bfmo;
...
class ItemdSign extends Component
{
    ...
    public $rdf_number;
    public $to, $from, $date, $dept, $reason, $checkedby, $evalby, $saveS;
    ...
    public function render()
    {
        ...
        $rdf = ItemDisposal::whereNull('noted_date')->where('rdf_number', 'like', '%' . $this->search . '%')
            ->latest()->get();

        return view('livewire.bfmo.itemd-sign', [
            'rdf' => $rdf
        ]);
    }
}
